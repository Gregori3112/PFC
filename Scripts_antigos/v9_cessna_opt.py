...
def FCN(x: np.ndarray, return_LD_only=False) -> float:
    ...
    try:
        ...
        with suppress_all_output():
            ...
            #    return PENALIDADE
            # AR, span, taper, sweep, twist, alpha = x
            vsp.SetParmVal(wing_id, "AR", "WingGeom", AR)
            vsp.SetParmVal(wing_id, "Span", "WingGeom", span)
            vsp.SetParmVal(wing_id, "Taper", "WingGeom", taper)
            vsp.SetParmVal(wing_id, "Sweep", "WingGeom", sweep)
            vsp.SetParmVal(wing_id, "Twist", "WingGeom", twist)
            vsp.SetParmVal(wing_id, "Alpha", "WingGeom", alpha)
